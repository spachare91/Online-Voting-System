    ...
    <div class="container" style="padding-top:150px;">
       ...
       $DB_NAME="db_evoting";
        ...
        if ($result22=mysqli_query($conn,$sql22)) {
          ...
          if($rowcount>0) {
            $sql123="select * from tbl_users where full_name='$name' and email='$email'and voter_id='$voterID'";
            $runquery=mysqli_query($conn, $sql123);
            $result123=mysqli_fetch_assoc($runquery);
