...
<html lang="en">
  ...
  if(isset($_POST['submit222'])){
    ...
    $insertquery="insert into tbl_nomine(nname,details,party,src) values('$name','$details','$party','$src') ";
      ...
      <div class="row">
        <div class="col-sm-12" style="border:2px solid gray;">
          ...
          <div class="page-header">
            <h2 class="specialHead">Enter Candidate Details.</h2>
          ...
          <div class="form-group">
            ...
            <input type="text" name="details" placeholder="Details here" class="form-control"/><br>

            <label>Party :</label><br>
            <input type="text" name="party" placeholder="Party name" class="form-control"/><br>



            <label>Upload Image Address of Candidate :</label><br>
            <input id="id1" type="text" name="src"  placeholder="Image link" class="form-control" required/><br>
