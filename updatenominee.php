...
<html lang="en">
  ...
  require 'dbcon.php';
                                          ...
                                          $selectquery="select * from tbl_nomine where id=$id";
                                          ...
                                          if(isset($_POST['submit222'])){
                                            ...
                                            $updatequery="update tbl_nomine set nname='$name',details='$details',src='$src' where id=$id ";
      ...
      <div class="row">
        <div class="col-sm-12" style="border:2px solid gray;">
          ...
          <div class="page-header">
            <h2 class="specialHead">Update Nominee Details</h2>

          </div>
          
          <form action="" method="post">
          <div class="form-group">
            <label>Nomine Name:</label><br>
            
            <input type="text" name="nname" value="<?php echo $result['nname'] ?>" title="Enter Your Full Name" placeholder="Enter Full Name" class="form-control" required/><br>

            <label>Details :</label><br>
            <input type="text" name="details" value="<?php echo $result['details'] ?>" placeholder="Details here" class="form-control"/><br>

            <label>Upload Image Address of Candidate :</label><br>
            <input id="id1" type="text" name="src" value="<?php echo $result['src'] ?>" placeholder="Image link" class="form-control" required/><br>

          </div>
          <hr>
              <button type="submit" name="submit222" class="btn btn-primary"><strong>Update</strong></button>
